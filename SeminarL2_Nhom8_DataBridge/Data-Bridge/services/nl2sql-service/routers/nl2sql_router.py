...
from core.schema_cache import invalidate_cache
...
async def refresh_schema():
    """Force-invalidate schema cache so next query fetches fresh schema."""
    invalidate_cache()
    return {"success": True, "message": "Schema cache invalidated"}
