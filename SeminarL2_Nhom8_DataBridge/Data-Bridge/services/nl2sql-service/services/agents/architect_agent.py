...
from core.prompts import ARCHITECT_AGENT_PROMPT
...
class ArchitectAgent:
    ...
    def __init__(self, llm_client: BaseLLMClient):
        ...
        self.prompt_template = ARCHITECT_AGENT_PROMPT
        self.schema = get_schema()

    def run(self, user_query: str, schema: str | None = None) -> ArchitectOutput:
